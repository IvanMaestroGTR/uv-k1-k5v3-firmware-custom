...
// The `unit_id` argument represents the 16-bit unit identifier used in
// MDC1200 packets. Typical values are expressed as four-digit decimal
// IDs (e.g. 1234) but encoded in the firmware as a 16-bit value. For
// example, to send unit "0088" use `unit_id = 0x0088`.
